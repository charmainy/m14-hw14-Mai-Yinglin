...
1. Navbar – Fully responsive, with toggle menu on mobile devices.
2. Cards – Used in the skills section to highlight different areas of expertise.
3. Button – Contact Me button styled using Bootstrap's 'btn'class.

Bootstrap Grid System
- Used 'container', 'row', 'col' classes for responsive layout in skills section.
- Adjusts layout across desktop, tablet, and mobile view.

Spacing Utilities
- Applied 'my-5', 'mb-4', 'py-5', 'mx-auto', 'w-75', etc., for consistent spacing.